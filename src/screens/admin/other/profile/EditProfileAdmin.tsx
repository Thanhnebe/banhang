...
import { StyleEditProfileAdmin } from './StyleEditProfileAdmin';
...
const EditProfileAdmin: React.FC = () => {
  ...
  return (
    <Pressable onPress={Keyboard.dismiss} style={StyleEditProfileAdmin.container}>
      <View style={StyleEditProfileAdmin.container}>
        <View style={StyleEditProfileAdmin.viewheader}>
          <View style={StyleEditProfileAdmin.headerTitle}>
            <CustomHeader title='Chỉnh sửa thông tin admin' color={COLOR.REDONE} fontSize={Responsive.RFPercentage(2.5)} />
            <TouchableOpacity
            ...
            >
              <Text style={{
                ...StyleEditProfileAdmin.textHeader,
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1, paddingBottom: 10 }} showsVerticalScrollIndicator={false}>
          <View style={StyleEditProfileAdmin.containerBody}>
            {photoUrl ? (
              <ImagePicker
                localPhoto={photoUrl}
                handleSelectPhoto={() => {
            ...
            <View>
              <View style={StyleEditProfileAdmin.viewinput}>
                <Text style={StyleEditProfileAdmin.textinput}>Họ và tên</Text>
                <InputCustom
              ...
              <View style={StyleEditProfileAdmin.viewinput}>
                <Text style={StyleEditProfileAdmin.textinput}>Email</Text>
                <InputCustom
              ...
              <View style={StyleEditProfileAdmin.viewinput}>
                <Text style={StyleEditProfileAdmin.textinput}>Số điện thoại</Text>
                <InputCustom
              ...
              <View style={StyleEditProfileAdmin.viewgender}>
                <Text style={StyleEditProfileAdmin.textinput}>Giới tính</Text>
                <PickerCustom
              ...
              <TouchableOpacity style={StyleEditProfileAdmin.viewdatepicker} onPress={() => setOpen(true)}>
                <Text style={StyleEditProfileAdmin.textinput}>Ngày sinh</Text>
                <InputCustom
